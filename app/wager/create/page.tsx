...
export default function CreateWagerPage() {
  ...
  const handleCreateWager = (e: React.FormEvent) => {
    ...
    if (!validateRequired(selectedGame, "Game")) return
    if (!validateRequired(gameMode, "Game Mode")) return
    if (!validateWagerAmount(wagerAmount, 1, 250)) return
    if (!validateRequired(gamePlatform, "Platform")) return
