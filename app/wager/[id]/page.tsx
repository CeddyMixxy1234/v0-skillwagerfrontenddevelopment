  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <Link href="/wager/browse" className="inline-flex items-center gap-2 text-primary hover:underline mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <Card className="p-6 border-border">
              ...
              <div className="space-y-3">
                <h3 className="font-semibold text-sm">Wager Rules:</h3>
          ...
          {/* Sidebar */}
          <div>
            <Card className="p-6 border-border sticky top-24 space-y-4">
              ...
              {!joined ? (
                <>
                  ...
                  <div className="p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg flex gap-2 text-xs text-yellow-700 dark:text-yellow-400">
