  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <Link href="/matches" className="inline-flex items-center gap-2 text-primary hover:underline mb-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-6 border-border">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-sm font-medium">{match.yourStats.kills} Kills</span>
                    <span className="text-sm font-medium text-muted-foreground">{match.opponentStats.kills} Kills</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-sm font-medium">{match.yourStats.damage} Damage</span>
                    <span className="text-sm font-medium text-muted-foreground">
                      {match.opponentStats.damage} Damage
                    </span>
                  </div>
                  <div className="w-full bg-border rounded-full h-2 overflow-hidden">
                    <div
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-sm font-medium">{match.yourStats.headshots} Headshots</span>
                    <span className="text-sm font-medium text-muted-foreground">
                      {match.opponentStats.headshots} Headshots
                    </span>
                  </div>
                  <div className="w-full bg-border rounded-full h-2 overflow-hidden">
                    <div
              ...
              <div className="grid grid-cols-2 gap-4 mt-8 pt-6 border-t border-border">
                ...
                <div className="space-y-3">
                  <h3 className="font-semibold text-sm">Opponent Stats</h3>
                  <div className="space-y-2">
                    <p className="text-sm">
                      <span className="text-muted-foreground">K/D:</span>{" "}
                      <span className="font-semibold">
