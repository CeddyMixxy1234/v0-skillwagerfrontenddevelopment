    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <Card className="p-6 mb-8 border-border">
          <h2 className="text-2xl font-bold mb-4">Wager Analytics</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-green-500">{completedWagers.length}</p>
            </div>
            <div className="text-center">
        ...
        {filteredWagers.length > 0 ? (
              ...
              <Card key={wager.id} className="p-6 border-border hover:border-primary/30 transition-colors">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className={`flex items-center gap-2 px-3 py-2 rounded-lg border whitespace-nowrap ${getStatusColor(wager.status)}`}
                    >
                  ...
                  <div className="text-right">
                    ...
                    {wager.status === "playing" && <p className="font-semibold">{wager.timeLeft}</p>}
                    {wager.status === "pending_verification" && <p className="font-semibold">{wager.joined}</p>}
                    {wager.status === "completed" && (
                      <>
                        ...
                        <p className="text-xs text-green-500 font-semibold">+${wager.payout}</p>
                      </>
                    )}
                  </div>
                </div>
          ...
          <Card className="p-12 text-center border-border">
            ...
            <p className="text-muted-foreground mb-4">No {filterStatus === "all" ? "" : filterStatus} wagers</p>
            <Link href="/wager/browse" className="text-primary hover:underline">
