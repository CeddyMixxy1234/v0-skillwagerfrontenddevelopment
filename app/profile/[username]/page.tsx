...
export default function ProfilePage({ params }: { params: { username: string } }) {
  ...
  const handleChallengeSubmit = () => {
    if (selectedGame && wagerAmount) {
      ...
      if (currentUser) {
        console.log("[v0] Challenge created:", {
          to: username,
          game: selectedGame,
          amount: wagerAmount,
          timestamp: new Date(),
  ...
  const handleMessagePlayer = () => {
    ...
    alert(message)
    console.log("[v0] Message compose opened for:", playerData.username)
  }
            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={() => {
                  ...
                  console.log("[v0] Challenge form toggled for:", playerData.username)
                }}
              >
